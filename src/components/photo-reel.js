...
const ReelCarousel = ({ activePhoto, onPrevPhoto, onNextPhoto, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <IconButton type='button' disabled={!onPrevPhoto} onClick={() => onPrevPhoto()}>
        ...
        <IconButton type='button' disabled={!onNextPhoto} onClick={() => onNextPhoto()}>
...
const PhotoReel = () => {
  ...
  return <>
          ...
          {rowPhotos
            .map((photo, index) =>
              photo ?
                ...
                >
                  <GatsbyImage image={photo.gatsbyImageData} alt="" />
    ...
    <ReelCarousel
      ...
      onPrevPhoto={activePhotoIndex > 0 ? () => setActivePhotoIndex(activePhotoIndex - 1) : null}
      onNextPhoto={activePhotoIndex < (photos.length - 1) ? () => setActivePhotoIndex(activePhotoIndex + 1) : null}
